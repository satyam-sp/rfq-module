...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { color: @variant.color, cost: @variant.cost, name: @variant.name, price: @variant.price, product_id: @variant.product_id }
    end
  ...
  test "should update variant" do
    patch :update, id: @variant, variant: { color: @variant.color, cost: @variant.cost, name: @variant.name, price: @variant.price, product_id: @variant.product_id }
    assert_redirected_to variant_path(assigns(:variant))
  end
